...
async def RiZoeLX():
    ...
    if STRING21:
        ...
        try:
            ...
            await Riz21(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz21(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz21(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING22:
        ...
        try:
            ...
            await Riz22.start()
            await Riz22(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz22(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz22(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING23:
        ...
        try:
            ...
            await  Riz23.start()
            await Riz23(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz23(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz23(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING24:
        ...
        try:
            ...
            await Riz24.start()
            await Riz24(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz24(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz24(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING25:
        ...
        try:
            ...
            await Riz25.start()
            await Riz25(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz25(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz25(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING26:
        ...
        try:
            ...
            await Riz26.start()
            await Riz26(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz26(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz26(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING27:
        ...
        try:
            ...
            await Riz27.start()
            await Riz27(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz27(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz27(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING28:
        ...
        try:
            print("Booting Up The Client 18")
            await Riz28.start()
            await Riz28(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz28(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz28(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING29:
        ...
        try:
            ...
            await Riz29.start()
            await Riz29(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz29(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz29(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING30:
        ...
        try:
            ...
            await Riz30.start()
            await Riz30(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz30(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz30(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING31:
        ...
        try:
            ...
            await Riz31.start()
            await Riz31(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz31(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz31(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING32:
        ...
        try:
            print("Booting Up The Client 32")
            await Riz32.start()
            await Riz32(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz32(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz32(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING33:
        ...
        try:
            ...
            await Riz33.start()
            await Riz33(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz33(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz33(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING34:
        ...
        try:
            ...
            await Riz34.start()
            await Riz34(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz34(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz34(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING35:
        ...
        try:
            print("Booting Up The Client 35")
            await Riz35.start()
            await Riz35(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz35(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz35(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
    ...
    if STRING36:
        ...
        try:
            ...
            await Riz36(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz36(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz36(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING37:
        ...
        try:
            ...
            await Riz37(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz37(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz37(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING38:
        ...
        try:
            ...
            await Riz38(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz38(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz38(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING39:
        ...
        try:
            ...
            await Riz39(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz39(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz39(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if STRING40:
        ...
        try:
            ...
            await Riz40(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz40(functions.channels.JoinChannelRequest(channel="@LofiLifeXD"))
            await Riz40(functions.channels.JoinChannelRequest(channel="@REBELBOT_SUPPORT"))
            botid = telethon.utils.get_peer_id(botme)
            SUDO_USERS.append(botid)
        except Exception as e:
            print(e)
